...
export default function App() {
  ...
  return (
    <div className="flex flex-col" style={{ background: '#080f1e', minHeight: '100dvh' }}>
      ...
      {/* ── CONTENT ── */}
      <div className="flex-1 flex overflow-hidden" style={{ paddingBottom: mode === 'calculator' ? 44 : 0 }}>
        ...
        <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 border-t-2 border-white/10 flex" style={{ background: '#0a1322', paddingBottom: 'env(safe-area-inset-bottom)' }}>
          {[
            ...
            <button
              ...
              style={{ minHeight: 44 }}
              className={`flex-1 flex flex-col items-center justify-center gap-1 py-2 font-semibold transition-all active:opacity-70 ${
                mobileTab === t.id
